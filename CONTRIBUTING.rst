...
Welcome to ``pyoptimizer_server`` contributor's guide.
...
If you experience bugs or general issues with ``pyoptimizer_server``, please
...
You can help improve ``pyoptimizer_server`` docs by making them more readable
and coherent, or by adding missing information and correcting mistakes.

``pyoptimizer_server`` documentation uses Sphinx_ as its main documentation
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
    ...
    .. tip::
       ...
       propose changes in ``pyoptimizer_server``'s files. While this mechanism can
...
::
    ...
    conda create -n pyoptimizer_server python=3 six virtualenv pytest pytest-cov
    conda activate pyoptimizer_server
...
3. Clone this copy to your local disk:
   ...
   ::
       ...
       git clone git@github.com:YourLogin/pyoptimizer_server.git
       cd pyoptimizer_server
...
5. Install |pre-commit|_:
   ...
   ``pyoptimizer_server`` comes with a lot of hooks configured to automatically
...
.. [#contrib1] Even though, these resources focus on open source projects and communities,
...
.. _issue tracker: https://github.com/<USERNAME>/pyoptimizer_server/issues

.. _repository: https://github.com/<USERNAME>/pyoptimizer_server
